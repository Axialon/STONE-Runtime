...
for(const f of ['common.mjs','registry.mjs','humanoid.mjs','humanoid-session.mjs','drone.mjs','drone-session.mjs','control-session.mjs','benchmark.mjs'])assets.set('/packages/lab/'+f,new URL('packages/lab/'+f,root));
